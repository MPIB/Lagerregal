...
urlpatterns = [
    ...
    url(r'^manufacturers/(?P<manufacturer>[^/]*)/urls/view/(?P<pk>[0-9]*)/$', permission_required("devices.read_url")(UrlDetail.as_view()), name="url-detail"),
    url(r'^manufacturers/(?P<manufacturer>[^/]*)/urls/add$', permission_required("devices.add_vendor")(UrlCreate.as_view()), name="url-add"),
    url(r'^manufacturers/(?P<manufacturer>[^/]*)/urls/(?P<pk>[0-9]*)/edit/$', permission_required("devices.change_url")(UrlUpdate.as_view()), name="url-edit"),
    url(r'^manufacturers/(?P<manufacturer>[^/]*)/urls/(?P<pk>[0-9]*)/delete/$', permission_required("devices.delete_url")(UrlDelete.as_view()), name="url-delete"),
