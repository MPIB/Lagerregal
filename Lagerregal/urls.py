...
urlpatterns = patterns('',
    ...
    url(r'^devices/public/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', PublicDeviceListView.as_view(), name="public-device-list"),
    url(r'^devices/public/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', PublicDeviceListView.as_view(), name="public-device-list"),
