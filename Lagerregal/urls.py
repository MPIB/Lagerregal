...
urlpatterns = patterns('',
    ...
    url(r'^devices/(?P<page>[0-9]*)$', login_required(DeviceList.as_view()), name="device-list"),
    url(r'^devices/(?P<page>[0-9]*)/(?P<filter>.*)$', login_required(DeviceList.as_view()), name="device-list-filtered"),
    url(r'^devices/(?P<filter>.*)$', login_required(DeviceList.as_view()), name="device-list-filtered"),
