...
urlpatterns = patterns('',
    ...
    url(r'^devices/(?P<pk>[0-9]*)/history/(?P<page>[0-9]*)$', permission_required("devices.change_device", raise_exception=True)(DeviceHistoryList.as_view()), name="device-history-list"),
    url(r'^devices/(?P<pk>[0-9]*)/history/revision/(?P<revision>[0-9]*)$', permission_required("devices.change_device", raise_exception=True)(DeviceHistory.as_view()), name="device-history"),
    url(r'^devices/(?P<pk>[0-9]*)/lending/$', permission_required("devices.lend_device", raise_exception=True)(DeviceLendingList.as_view()), name="device-lending-list"),
    url(r'^devices/(?P<pk>[0-9]*)/lending/(?P<page>[0-9]*)$', permission_required("devices.lend_device", raise_exception=True)(DeviceLendingList.as_view()), name="device-lending-list"),
    ...
    url(r'^devices/templates/add$', permission_required("devices.add_template", raise_exception=True)(TemplateCreate.as_view()), name="template-add"),
    ...
    url(r'^types/sorting/(?P<sorting>[^/]*)$', permission_required("devicetypes.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)$', permission_required("devicetypes.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devicetypes.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devicetypes.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/add$', permission_required("devicetypes.add_type", raise_exception=True)(TypeCreate.as_view()), name="type-add"),
    ...
    url(r'^rooms/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_room", raise_exception=True)(RoomList.as_view()), name="room-list"),
    url(r'^rooms/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_room", raise_exception=True)(RoomList.as_view()), name="room-list"),
    url(r'^rooms/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_room", raise_exception=True)(RoomList.as_view()), name="room-list"),
    url(r'^rooms/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_room", raise_exception=True)(RoomList.as_view()), name="room-list"),
    url(r'^rooms/add$', permission_required("devices.add_room", raise_exception=True)(RoomCreate.as_view()), name="room-add"),
    ...
    url(r'^buildings/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_building", raise_exception=True)(BuildingList.as_view()), name="building-list"),
    url(r'^buildings/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_building", raise_exception=True)(BuildingList.as_view()), name="building-list"),
    url(r'^buildings/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_building", raise_exception=True)(BuildingList.as_view()), name="building-list"),
    url(r'^buildings/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_building", raise_exception=True)(BuildingList.as_view()), name="building-list"),
    url(r'^buildings/add$', permission_required("devices.add_building", raise_exception=True)(BuildingCreate.as_view()), name="building-add"),
    ...
    url(r'^manufacturers/page/(?P<page>[0-9]*)$', permission_required("devices.read_manufacturer", raise_exception=True)(ManufacturerList.as_view()), name="manufacturer-list"),
    url(r'^manufacturers/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_manufacturer", raise_exception=True)(ManufacturerList.as_view()), name="manufacturer-list"),
    url(r'^manufacturers/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_manufacturer", raise_exception=True)(ManufacturerList.as_view()), name="manufacturer-list"),
    url(r'^manufacturers/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_manufacturer", raise_exception=True)(ManufacturerList.as_view()), name="manufacturer-list"),
    url(r'^manufacturers/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_manufacturer", raise_exception=True)(ManufacturerList.as_view()), name="manufacturer-list"),
    url(r'^manufacturers/add$', permission_required("devices.add_manufacturer", raise_exception=True)(ManufacturerCreate.as_view()), name="manufacturer-add"),
    ...
    url(r'^mails/add$', permission_required("mail.add_mailtemplate", raise_exception=True)(MailCreate.as_view()), name="mail-add"),
    ...
    url(r'^devicegroups/sorting/(?P<sorting>[^/]*)$', permission_required("devicegroups.read_devicegroup", raise_exception=True)(DevicegroupList.as_view()), name="devicegroup-list"),
    url(r'^devicegroups/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)$', permission_required("devicegroups.read_devicegroup", raise_exception=True)(DevicegroupList.as_view()), name="devicegroup-list"),
    url(r'^devicegroups/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devicegroups.read_devicegroup", raise_exception=True)(DevicegroupList.as_view()), name="devicegroup-list"),
    url(r'^devicegroups/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devicegroups.read_devicegroup", raise_exception=True)(DevicegroupList.as_view()), name="devicegroup-list"),
    url(r'^devicegroups/add$', permission_required("devicegroups.add_devicegroup", raise_exception=True)(DevicegroupCreate.as_view()), name="devicegroup-add"),
    ...
    url(r'^ipaddresses/add$', permission_required("network.add_ipaddress", raise_exception=True)(IpAddressCreate.as_view()), name="ipaddress-add"),
...
urlpatterns += format_suffix_patterns(patterns('',
    ...
    url(r'^api/devices/search/$', DeviceApiSearch.as_view(), name='device-api-search'),
