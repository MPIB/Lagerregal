...
urlpatterns = [
    ...
    path('devices/page/<int:page>/', devices_views.DeviceList.as_view(), name="device-list"),
    path('devices/department/<department>/sorting/<sorting>/filter/<filter>/', devices_views.DeviceList.as_view(), name="device-list"),
    path('devices/page/<int:page>/department/<department>/sorting/<sorting>/filter/<filter>/', devices_views.DeviceList.as_view(), name="device-list"),
    ...
    path('devices/<int:pk>/lending/page/<int:page>/', devices_views.DeviceLendingList.as_view(), name="device-lending-list"),
    ...
    path('devices/public/page/<int:page>/', xframe_options_exempt(devices_views.PublicDeviceListView.as_view()), name="public-device-list"),
    path('devices/public/sorting/<sorting>/', xframe_options_exempt(devices_views.PublicDeviceListView.as_view()), name="public-device-list"),
    path('devices/public/page/<int:page>/sorting/<sorting>/', xframe_options_exempt(devices_views.PublicDeviceListView.as_view()), name="public-device-list"),
    path('devices/public/sorting/<sorting>/group/<group>/', xframe_options_exempt(devices_views.PublicDeviceListView.as_view()), name="public-device-list"),
    path('devices/public/page/<int:page>/sorting/<sorting>/group/<group>/', xframe_options_exempt(devices_views.PublicDeviceListView.as_view()), name="public-device-list"),
    path('devices/public/sorting/<sorting>/group/<group>/filter/<filter>/', xframe_options_exempt(devices_views.PublicDeviceListView.as_view()), name="public-device-list"),
    path('devices/public/page/<int:page>/sorting/<sorting>/group/<group>/filter/<filter>/', xframe_options_exempt(devices_views.PublicDeviceListView.as_view()), name="public-device-list"),
    ...
    path('devices/templates/page/<int:page>/', devices_views.TemplateList.as_view(), name="template-list"),
    ...
    path('types/page/<int:page>/', devicetypes_views.TypeList.as_view(), name="type-list"),
    path('types/sorting/<sorting>/', devicetypes_views.TypeList.as_view(), name="type-list"),
    path('types/page/<int:page>/sorting/<sorting>/', devicetypes_views.TypeList.as_view(), name="type-list"),
    path('types/sorting/<sorting>/filter/<filter>/', devicetypes_views.TypeList.as_view(), name="type-list"),
    path('types/page/<int:page>/sorting/<sorting>/filter/<filter>/', devicetypes_views.TypeList.as_view(), name="type-list"),
    ...
    path('rooms/page/<int:page>/', devices_views.RoomList.as_view(), name="room-list"),
    path('rooms/sorting/<sorting>/', devices_views.RoomList.as_view(), name="room-list"),
    path('rooms/page/<int:page>/sorting/<sorting>/', devices_views.RoomList.as_view(), name="room-list"),
    path('rooms/sorting/<sorting>/filter/<filter>/', devices_views.RoomList.as_view(), name="room-list"),
    path('rooms/page/<int:page>/sorting/<sorting>/filter/<filter>/', devices_views.RoomList.as_view(), name="room-list"),
    ...
    path('buildings/page/<int:page>/', devices_views.BuildingList.as_view(), name="building-list"),
    path('buildings/sorting/<sorting>/', devices_views.BuildingList.as_view(), name="building-list"),
    path('buildings/page/<int:page>/sorting/<sorting>/', devices_views.BuildingList.as_view(), name="building-list"),
    path('buildings/sorting/<sorting>/filter/<filter>/', devices_views.BuildingList.as_view(), name="building-list"),
    path('buildings/page/<int:page>/sorting/<sorting>/filter/<filter>/', devices_views.BuildingList.as_view(), name="building-list"),
    ...
    path('manufacturers/page/<int:page>/', devices_views.ManufacturerList.as_view(), name="manufacturer-list"),
    path('manufacturers/sorting/<sorting>/', devices_views.ManufacturerList.as_view(), name="manufacturer-list"),
    path('manufacturers/page/<int:page>/sorting/<sorting>/', devices_views.ManufacturerList.as_view(), name="manufacturer-list"),
    path('manufacturers/sorting/<sorting>/filter/<filter>/', devices_views.ManufacturerList.as_view(), name="manufacturer-list"),
    path('manufacturers/page/<int:page>/sorting/<sorting>/filter/<filter>/', devices_views.ManufacturerList.as_view(), name="manufacturer-list"),
    ...
    path('mails/page/<int:page>/', mail_views.MailList.as_view(), name="mail-list"),
    ...
    path('devicegroups/page/<int:page>/', devicegroups_views.DevicegroupList.as_view(), name="devicegroup-list"),
    path('devicegroups/department/<department>/sorting/<sorting>/filter/<filter>/', devicegroups_views.DevicegroupList.as_view(), name="devicegroup-list"),
    path('devicegroups/page/<int:page>/department/<department>/sorting/<sorting>/filter/<filter>/', devicegroups_views.DevicegroupList.as_view(), name="devicegroup-list"),
    ...
    path('devicetags/page/<int:page>/', devicetags_views.DevicetagList.as_view(), name="devicetag-list"),
    path('devicetags/sorting/<sorting>/', devicetags_views.DevicetagList.as_view(), name="devicetag-list"),
    path('devicetags/page/<int:page>/sorting/<sorting>/', devicetags_views.DevicetagList.as_view(), name="devicetag-list"),
    path('devicetags/sorting/<sorting>/filter/<filter>/', devicetags_views.DevicetagList.as_view(), name="devicetag-list"),
    path('devicetags/page/<int:page>/sorting/<sorting>/filter/<filter>/', devicetags_views.DevicetagList.as_view(), name="devicetag-list"),
    ...
    path('sections/page/<int:page>/', locations_views.SectionList.as_view(), name="section-list"),
    path('sections/sorting/<sorting>/', locations_views.SectionList.as_view(), name="section-list"),
    path('sections/page/<int:page>/sorting/<sorting>/', locations_views.SectionList.as_view(), name="section-list"),
    path('sections/sorting/<sorting>/filter/<filter>/', locations_views.SectionList.as_view(), name="section-list"),
    path('sections/page/<int:page>/sorting/<sorting>/filter/<filter>/', locations_views.SectionList.as_view(), name="section-list"),
    ...
    path('departments/page/<int:page>/', users_views.DepartmentList.as_view(), name="department-list"),
    path('departments/sorting/<sorting>/', users_views.DepartmentList.as_view(), name="department-list"),
    path('departments/page/<int:page>/sorting/<sorting>/', users_views.DepartmentList.as_view(), name="department-list"),
    path('departments/sorting/<sorting>/filter/<filter>/', users_views.DepartmentList.as_view(), name="department-list"),
    path('departments/page/<int:page>/sorting/<sorting>/filter/<filter>/', users_views.DepartmentList.as_view(), name="department-list"),
    ...
    path('ipaddresses/department/<department>/', network_views.IpAddressList.as_view(), name="ipaddress-list"),
    path('ipaddresses/department/<department>/filter/<filter>/', network_views.IpAddressList.as_view(), name="ipaddress-list"),
    path('ipaddresses/department/<department>/filter/<filter>/search/<search>/', network_views.IpAddressList.as_view(), name="ipaddress-list"),
    path('ipaddresses/page/<int:page>/', network_views.IpAddressList.as_view(), name="ipaddress-list"),
    path('ipaddresses/page/<int:page>/department/<department>/', network_views.IpAddressList.as_view(), name="ipaddress-list"),
    path('ipaddresses/page/<int:page>/department/<department>/filter/<filter>/', network_views.IpAddressList.as_view(), name="ipaddress-list"),
    path('ipaddresses/page/<int:page>/department/<department>/filter/<filter>/search/<search>/', network_views.IpAddressList.as_view(), name="ipaddress-list"),
    ...
    path('users/department/<department>/filter/<filter>/', users_views.UserList.as_view(), name="user-list"),
    path('users/page/<int:page>/department/<department>/filter/<filter>/', users_views.UserList.as_view(), name="user-list"),
    ...
    path('history/global/page/<int:page>/', history_views.Globalhistory.as_view(), name="globalhistory"),
    path('history/<int:content_type_id>/<int:object_id>/', history_views.HistoryList.as_view(), name="history-list"),
    path('history/<int:content_type_id>/<int:object_id>/page/<int:page>/', history_views.HistoryList.as_view(), name="history-list"),
    ...
    path('devices_ajax/puppetdetails/', login_required(devices_ajax.PuppetDetails.as_view()), name="puppet-details"),
    path('devices_ajax/puppetsoftware/', login_required(devices_ajax.PuppetSoftware.as_view()), name="puppet-software"),
]
