...
urlpatterns = patterns('',
    ...
    url(r'^devices/(?P<pk>[0-9]*)/history/(?P<revision>[0-9]*)$', login_required(DeviceHistory.as_view()), name="device-history"),
     ...
     url(r'^devices/templates/$', login_required(TemplateList.as_view()), name="template-list"),
    url(r'^devices/templates/add$', login_required(TemplateCreate.as_view()), name="template-add"),
    url(r'^devices/templates/(?P<pk>[0-9]*)/edit/$', login_required(TemplateUpdate.as_view()), name="template-edit"),
    url(r'^devices/templates/(?P<pk>[0-9]*)/delete/$', login_required(TemplateDelete.as_view()), name="template-delete"),
    ...
    url(r'^ipaddresses/filter/(?P<filter>.*)$', login_required(IpAddressList.as_view()), name="ipaddress-list-filtered"),
    url(r'^ipaddresses/page/(?P<page>[0-9]*)/filter/(?P<filter>.*)$', login_required(IpAddressList.as_view()), name="ipaddress-list-filtered"),
