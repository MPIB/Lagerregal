...
urlpatterns = [
    ...
    url(r'^ipaddresses/department/(?P<department>[^/]*)$', permission_required("network.read_ipaddress")(IpAddressList.as_view()), name="ipaddress-list"),
    ...
    url(r'^ipaddresses/department/(?P<department>[^/]*)/usage/(?P<usage>[^/]*)$', permission_required("network.read_ipaddress")(IpAddressList.as_view()), name="ipaddress-list"),
    url(r'^ipaddresses/page/(?P<page>[0-9]*)/department/(?P<department>[^/]*)/usage/(?P<usage>[^/]*)$', permission_required("network.read_ipaddress")(IpAddressList.as_view()), name="ipaddress-list"),
    url(r'^ipaddresses/department/(?P<department>[^/]*)/usage/(?P<usage>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("network.read_ipaddress")(IpAddressList.as_view()), name="ipaddress-list"),
    url(r'^ipaddresses/page/(?P<page>[0-9]*)/department/(?P<department>[^/]*)/usage/(?P<usage>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("network.read_ipaddress")(IpAddressList.as_view()), name="ipaddress-list"),
