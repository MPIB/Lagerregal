...
urlpatterns = patterns('',
    ...
    url(r'^ipaddresses/filter/(?P<filter>[^/]*)$', permission_required("network.read_ipaddress")(IpAddressList.as_view()), name="ipaddress-list-filtered"),
    url(r'^ipaddresses/page/(?P<page>[0-9]*)/filter/(?P<filter>[^/]*)$', permission_required("network.read_ipaddress")(IpAddressList.as_view()), name="ipaddress-list-filtered"),
