...
urlpatterns = [
    ...
    path('types/edit/<int:pk>/', TypeUpdate.as_view(), name="type-edit"),
    path('types/delete/<int:pk>/', TypeDelete.as_view(), name="type-delete"),
    path('types/view/<int:pk>/', TypeDetail.as_view(), name="type-detail"),
    path('types/merge/<int:oldpk>/<int:newpk>/', TypeMerge.as_view(), name="type-merge"),
    path('types/attribute/add/', TypeAttributeCreate.as_view(), name="typeattribute-add"),
    path('types/attribute/edit/<int:pk>/', TypeAttributeUpdate.as_view(), name="typeattribute-edit"),
    path('types/attribute/delete/<int:pk>/', TypeAttributeDelete.as_view(), name="typeattribute-delete"),
    ...
    path('rooms/edit/<pk>/', RoomUpdate.as_view(), name="room-edit"),
    path('rooms/delete/<pk>/', RoomDelete.as_view(), name="room-delete"),
    path('rooms/view/<pk>/', RoomDetail.as_view(), name="room-detail"),
    ...
    path('buildings/edit/<pk>/', BuildingUpdate.as_view(), name="building-edit"),
    path('buildings/delete/<pk>/', BuildingDelete.as_view(), name="building-delete"),
    path('buildings/view/<pk>/', BuildingDetail.as_view(), name="building-detail"),
    path('buildings/merge/<int:oldpk>/<int:newpk>/', BuildingMerge.as_view(), name="building-merge"),
    ...
    path('manufacturers/edit/<pk>/', ManufacturerUpdate.as_view(), name="manufacturer-edit"),
    path('manufacturers/delete/<pk>/', ManufacturerDelete.as_view(), name="manufacturer-delete"),
    path('manufacturers/view/<pk>/', ManufacturerDetail.as_view(), name="manufacturer-detail"),
    ...
    path('devicegroups/edit/<pk>/', DevicegroupUpdate.as_view(), name="devicegroup-edit"),
    path('devicegroups/view/<pk>/', DevicegroupDetail.as_view(), name="devicegroup-detail"),
    ...
    path('devicetags/edit/<pk>/', DevicetagUpdate.as_view(), name="devicetag-edit"),
    ...
    path('sections/edit/<pk>/', SectionUpdate.as_view(), name="section-edit"),
    path('sections/view/<pk>/', SectionDetail.as_view(), name="section-detail"),
    path('sections/delete/<pk>/', SectionDelete.as_view(), name="section-delete"),
    ...
    path('departments/edit/<pk>/', DepartmentUpdate.as_view(), name="department-edit"),
    path('departments/adduser/<pk>/', DepartmentAddUser.as_view(), name="department-add-user"),
    path('departments/removeuser/<pk>/', DepartmentDeleteUser.as_view(), name="department-remove-user"),
    path('departments/view/<pk>/', DepartmentDetail.as_view(), name="department-detail"),
    path('departments/delete/<pk>/', DepartmentDelete.as_view(), name="department-delete"),
    ...
    path('ipaddresses/edit/<pk>/', IpAddressUpdate.as_view(), name="ipaddress-edit"),
    path('ipaddresses/delete/<pk>/', IpAddressDelete.as_view(), name="ipaddress-delete"),
    path('ipaddresses/view/<pk>/', IpAddressDetail.as_view(), name="ipaddress-detail"),
    ...
    path('users/view/<int:pk>/', ProfileView.as_view(), name="userprofile"),
    path('users/view/<int:pk>/ipaddress/', UserIpAddress.as_view(), name="user-ipaddress"),
    path('users/view/<int:pk>/ipaddress/<int:ipaddress>/', UserIpAddressRemove.as_view(), name="user-ipaddress-remove"),
