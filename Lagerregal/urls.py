...
urlpatterns = [
    ...
    path('rooms/<int:pk>/edit/', RoomUpdate.as_view(), name="room-edit"),
    path('rooms/<int:pk>/delete/', RoomDelete.as_view(), name="room-delete"),
    ...
    path('buildings/<int:pk>/edit/', BuildingUpdate.as_view(), name="building-edit"),
    path('buildings/<int:pk>/delete/', BuildingDelete.as_view(), name="building-delete"),
    ...
    path('manufacturers/<int:pk>/edit/', ManufacturerUpdate.as_view(), name="manufacturer-edit"),
    ...
    path('mails/<int:pk>/', MailDetail.as_view(), name="mail-detail"),
    path('mails/<int:pk>/edit/', MailUpdate.as_view(), name="mail-edit"),
    path('mails/<int:pk>/delete/', MailDelete.as_view(), name="mail-delete"),
    ...
    path('devicegroups/<int:pk>/', DevicegroupDetail.as_view(), name="devicegroup-detail"),
    path('devicegroups/<int:pk>/edit/', DevicegroupUpdate.as_view(), name="devicegroup-edit"),
    path('devicegroups/<int:pk>/delete/', DevicegroupDelete.as_view(), name="devicegroup-delete"),
    ...
    path('devicetags/<int:pk>/edit/', DevicetagUpdate.as_view(), name="devicetag-edit"),
    path('devicetags/<int:pk>/delete/', DevicetagDelete.as_view(), name="devicetag-delete"),
    ...
    path('sections/<int:pk>/edit/', SectionUpdate.as_view(), name="section-edit"),
    path('sections/<int:pk>/delete/', SectionDelete.as_view(), name="section-delete"),
    ...
    path('departments/<int:pk>/edit/', DepartmentUpdate.as_view(), name="department-edit"),
    path('departments/<int:pk>/adduser/', DepartmentAddUser.as_view(), name="department-add-user"),
    path('departments/<int:pk>/removeuser/', DepartmentDeleteUser.as_view(), name="department-remove-user"),
    path('departments/<int:pk>/delete/', DepartmentDelete.as_view(), name="department-delete"),
    ...
    path('ipaddresses/<int:pk>/', IpAddressDetail.as_view(), name="ipaddress-detail"),
    path('ipaddresses/<int:pk>/edit/', IpAddressUpdate.as_view(), name="ipaddress-edit"),
    path('ipaddresses/<int:pk>/delete/', IpAddressDelete.as_view(), name="ipaddress-delete"),
...
urlpatterns += format_suffix_patterns([
    ...
    path('api/devices/<int:device>/pictures/<int:pk>/', DeviceApiPicture.as_view(), name='device-api-picture'),
    path('api/devices/<int:device>/pictures/<int:pk>/rotate/<orientation>/', DeviceApiPictureRotate.as_view(), name='device-api-picture-rotate'),
