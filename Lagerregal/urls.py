...
urlpatterns = patterns('',
    ...
    url(r'^devices/filter/(?P<filter>.*)/sorting/(?P<sorting>.*)$', permission_required("devices.read_device", raise_exception=True)(DeviceList.as_view()), name="device-list-filtered"),
    url(r'^devices/page/(?P<page>[0-9]*)/filter/(?P<filter>.*)/sorting/(?P<sorting>.*)$', permission_required("devices.read_device", raise_exception=True)(DeviceList.as_view()), name="device-list-filtered"),
