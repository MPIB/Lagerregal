...
urlpatterns = [
    ...
    url(r'^devices/public/sorting/(?P<sorting>[^/]*)/devicegroup/(?P<devicegroup>[^/]*)$', xframe_options_exempt(PublicDeviceListView.as_view()), name="public-device-list"),
    url(r'^devices/public/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/devicegroup/(?P<devicegroup>[^/]*)$', xframe_options_exempt(PublicDeviceListView.as_view()), name="public-device-list"),
    url(r'^devices/public/sorting/(?P<sorting>[^/]*)/devicegroup/(?P<devicegroup>[^/]*)/filter/(?P<filter>[^/]*)$', xframe_options_exempt(PublicDeviceListView.as_view()), name="public-device-list"),
    url(r'^devices/public/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/devicegroup/(?P<devicegroup>[^/]*)/filter/(?P<filter>[^/]*)$', xframe_options_exempt(PublicDeviceListView.as_view()), name="public-device-list"),
