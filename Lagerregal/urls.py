...
urlpatterns = patterns('',
    ...
    url(r'^devices/view/(?P<pk>[0-9]*)$', login_required(DeviceDetail.as_view()), name="device-detail"),
    ...
    url(r'^types/view/(?P<pk>.*)$', login_required(TypeDetail.as_view()), name="type-detail"),
