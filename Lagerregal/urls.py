...
urlpatterns = [
    ...
    path('types/<int:pk>/view/', TypeDetail.as_view(), name="type-detail"),
    ...
    path('rooms/<pk>/view/', RoomDetail.as_view(), name="room-detail"),
    ...
    path('buildings/<pk>/view/', BuildingDetail.as_view(), name="building-detail"),
    ...
    path('manufacturers/<pk>/view/', ManufacturerDetail.as_view(), name="manufacturer-detail"),
    ...
    path('mails/<pk>/view/', MailDetail.as_view(), name="mail-detail"),
    ...
    path('devicegroups/<pk>/view/', DevicegroupDetail.as_view(), name="devicegroup-detail"),
    ...
    path('sections/<pk>/view/', SectionDetail.as_view(), name="section-detail"),
    ...
    path('departments/<pk>/view/', DepartmentDetail.as_view(), name="department-detail"),
    ...
    path('ipaddresses/<pk>/view/', IpAddressDetail.as_view(), name="ipaddress-detail"),
    ...
    path('users/<int:pk>/view/', ProfileView.as_view(), name="userprofile"),
    path('users/<int:pk>/view/ipaddress/', UserIpAddress.as_view(), name="user-ipaddress"),
    path('users/<int:pk>/view/ipaddress/<int:ipaddress>/', UserIpAddressRemove.as_view(), name="user-ipaddress-remove"),
