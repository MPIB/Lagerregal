...
urlpatterns = patterns('',
    ...
    url(r'^types/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    ...
    url(r'^devicegroups/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_devicegroup", raise_exception=True)(DevicegroupList.as_view()), name="devicegroup-list"),
    url(r'^devicegroups/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)$', permission_required("devices.read_devicegroup", raise_exception=True)(DevicegroupList.as_view()), name="devicegroup-list"),
    url(r'^devicegroups/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_devicegroup", raise_exception=True)(DevicegroupList.as_view()), name="devicegroup-list"),
    url(r'^devicegroups/page/(?P<page>[0-9]*)/sorting/(?P<sorting>[^/]*)/filter/(?P<filter>[^/]*)$', permission_required("devices.read_devicegroup", raise_exception=True)(DevicegroupList.as_view()), name="devicegroup-list"),
