...
urlpatterns = patterns('',
    ...
    url(r'^types/$', permission_required("devices.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/(?P<page>[0-9]*)$', permission_required("devices.read_type", raise_exception=True)(TypeList.as_view()), name="type-list"),
    url(r'^types/add$', permission_required("devices.create_type", raise_exception=True)(TypeCreate.as_view()), name="type-add"),
    url(r'^types/edit/(?P<pk>[0-9]*)$', permission_required("devices.change_type", raise_exception=True)(TypeUpdate.as_view()), name="type-edit"),
    url(r'^types/delete/(?P<pk>[0-9]*)$', permission_required("devices.delete_type", raise_exception=True)(TypeDelete.as_view()), name="type-delete"),
    url(r'^types/view/(?P<pk>[0-9]*)$', permission_required("devices.read_type", raise_exception=True)(TypeDetail.as_view()), name="type-detail"),
    ...
    url(r'^types/attribute/add$', permission_required("devices.change_type", raise_exception=True)(TypeAttributeCreate.as_view()), name="typeattribute-add"),
    url(r'^types/attribute/edit/(?P<pk>[0-9]*)$', permission_required("devices.change_type", raise_exception=True)(TypeAttributeUpdate.as_view()), name="typeattribute-edit"),
    url(r'^types/attribute/delete/(?P<pk>[0-9]*)$', permission_required("devices.change_type", raise_exception=True)(TypeAttributeDelete.as_view()), name="typeattribute-delete"),
    ...
    url(r'^rooms/view/(?P<pk>.*)$', permission_required("devices.change_room", raise_exception=True)(RoomDetail.as_view()), name="room-detail"),
    ...
    url(r'^mails/$', permission_required("devices.read_mailtemplate", raise_exception=True)(MailList.as_view()), name="mail-list"),
    url(r'^mails/(?P<page>[0-9]*)$', permission_required("devices.read_mailtemplate", raise_exception=True)(MailList.as_view()), name="mail-list"),
    url(r'^mails/add$', permission_required("devices.create_mailtemplate", raise_exception=True)(MailCreate.as_view()), name="mail-add"),
    url(r'^mails/edit/(?P<pk>.*)$', permission_required("devices.change_mailtemplate", raise_exception=True)(MailUpdate.as_view()), name="mail-edit"),
    url(r'^mails/view/(?P<pk>.*)$', permission_required("devices.read_mailtemplate", raise_exception=True)(MailDetail.as_view()), name="mail-detail"),
    url(r'^mails/delete/(?P<pk>.*)$', permission_required("devices.delete_mailtemplate", raise_exception=True)(MailDelete.as_view()), name="mail-delete"),

    url(r'^ipaddresses/$', permission_required("devices.read_ipaddress", raise_exception=True)(IpAddressList.as_view()), name="ipaddress-list"),
    url(r'^ipaddresses/page/(?P<page>[0-9]*)$', permission_required("devices.read_ipaddress", raise_exception=True)(IpAddressList.as_view()), name="ipaddress-list"),
    url(r'^ipaddresses/filter/(?P<filter>.*)$', permission_required("devices.read_ipaddress", raise_exception=True)(IpAddressList.as_view()), name="ipaddress-list-filtered"),
    url(r'^ipaddresses/page/(?P<page>[0-9]*)/filter/(?P<filter>.*)$', permission_required("devices.read_ipaddress", raise_exception=True)(IpAddressList.as_view()), name="ipaddress-list-filtered"),
    url(r'^ipaddresses/add$', permission_required("devices.create_ipaddress", raise_exception=True)(IpAddressCreate.as_view()), name="ipaddress-add"),
    url(r'^ipaddresses/edit/(?P<pk>.*)$', permission_required("devices.change_ipaddress", raise_exception=True)(IpAddressUpdate.as_view()), name="ipaddress-edit"),
    url(r'^ipaddresses/delete/(?P<pk>.*)$', permission_required("devices.delete_ipaddress", raise_exception=True)(IpAddressDelete.as_view()), name="ipaddress-delete"),
    url(r'^ipaddresses/view/(?P<pk>.*)$', permission_required("devices.read_ipaddress", raise_exception=True)(IpAddressDetail.as_view()), name="ipaddress-detail"),
