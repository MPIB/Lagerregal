...
#think about changing this when you are not behind a firewall or on public LAN
...
# MEDIA_ROOT =  '/opt/Lagerregal/media'
...
STORAGE_ROOM = get_secret("STORAGE_ROOM")
...
AUTH_LDAP_USER_SEARCH = get_secret("AUTH_LDAP_USER_SEARCH")
AUTH_LDAP_GROUP_SEARCH = get_secret("AUTH_LDAP_GROUP_SEARCH")

LDAP_USER_SEARCH = get_secret("LDAP_USER_SEARCH")
...
# LABEL_TEMPLATES = get_secret("LABEL_TEMPLATES")
