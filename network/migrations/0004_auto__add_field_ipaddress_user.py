...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'IpAddress.user'
        db.add_column(u'network_ipaddress', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Lageruser'], null=True,
                                                                            on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IpAddress.user'
        db.delete_column(u'network_ipaddress', 'user_id')
