...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'IpAddress.last_seen'
        db.add_column(u'network_ipaddress', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IpAddress.last_seen'
        db.delete_column(u'network_ipaddress', 'last_seen')
