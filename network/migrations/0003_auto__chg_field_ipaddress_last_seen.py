...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'IpAddress.last_seen'
        db.alter_column(u'network_ipaddress', 'last_seen', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Changing field 'IpAddress.last_seen'
        db.alter_column(u'network_ipaddress', 'last_seen',
