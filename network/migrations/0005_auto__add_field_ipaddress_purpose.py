...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'IpAddress.purpose'
        db.add_column(u'network_ipaddress', 'purpose',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IpAddress.purpose'
        db.delete_column(u'network_ipaddress', 'purpose')
    ...
    models = {
        ...
        u'devices.lending': {
            ...
            'device': ('django.db.models.fields.related.ForeignKey', [],
                       {'to': u"orm['devices.Device']", 'null': 'True', 'blank': 'True'}),
        ...
        u'devices.room': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [],
                        {'blank': 'True', 'related_name': "'rooms'", 'null': 'True', 'on_delete': 'models.SET_NULL',
        ...
        u'network.ipaddress': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [],
                     {'to': u"orm['users.Lageruser']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
        u'users.lageruser': {
