...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IpAddress.department'
        db.add_column(u'network_ipaddress', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Department'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IpAddress.department'
        db.delete_column(u'network_ipaddress', 'department_id')
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'department': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'members'", 'null': 'True', 'to': u"orm['users.Department']"}),
        ...
        u'network.ipaddress': {
            ...
            'department': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Department']", 'null': 'True', 'blank': 'True'}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Device']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_seen': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'purpose': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Lageruser']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
        u'users.department': {
