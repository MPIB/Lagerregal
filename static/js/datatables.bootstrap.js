	...
	"bs_two_button": {
		"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
		{
			...
			var sAppend = '<ul class="pagination">'+
				'<li class="prev"><a class="'+oSettings.oClasses.sPagePrevDisabled+'" tabindex="'+oSettings.iTabIndex+'" role="button"><i class="icon-angle-left"></i> &nbsp;'+oLang.sPrevious+'</a></li>'+
				'<li class="next"><a class="'+oSettings.oClasses.sPageNextDisabled+'" tabindex="'+oSettings.iTabIndex+'" role="button">'+oLang.sNext+'&nbsp;<i class="icon-angle-right"></i> </a></li>'+
				'</ul>';
		...
		"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				$(nPaging).append(
					...
					'<li class="disabled"><a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPagePrevious+'"><i class="icon-angle-left"></i> &nbsp;'+oLang.sPrevious+'</a></li>'+
					'<li><a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageNext+'">'+oLang.sNext+'&nbsp;<i class="icon-angle-right"></i> </a></li>'+
