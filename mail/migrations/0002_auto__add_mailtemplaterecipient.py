...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'MailTemplateRecipient'
        db.create_table(u'mail_mailtemplaterecipient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mailtemplate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='default_recipients',
                                                                                   to=orm['mail.MailTemplate'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'mail', ['MailTemplateRecipient'])


    def backwards(self, orm):
        # Deleting model 'MailTemplateRecipient'
        db.delete_table(u'mail_mailtemplaterecipient')
    ...
    models = {
        ...
        u'mail.mailhistory': {
            ...
            'device': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.Device']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'mail.mailtemplate': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'usage': ('django.db.models.fields.CharField', [],
        ...
        u'mail.mailtemplaterecipient': {
            ...
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mailtemplate': ('django.db.models.fields.related.ForeignKey', [],
                             {'related_name': "'default_recipients'", 'to': u"orm['mail.MailTemplate']"}),
