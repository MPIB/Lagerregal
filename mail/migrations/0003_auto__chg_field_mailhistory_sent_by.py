...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailHistory.sent_by'
        db.alter_column(u'mail_mailhistory', 'sent_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Lageruser'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MailHistory.sent_by'
        raise RuntimeError("Cannot reverse this migration. 'MailHistory.sent_by' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MailHistory.sent_by'
        db.alter_column(u'mail_mailhistory', 'sent_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Lageruser']))
    ...
    models = {
        ...
        u'mail.mailhistory': {
            ...
            'sent_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Lageruser']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        u'mail.mailtemplaterecipient': {
            'Meta': {'object_name': 'MailTemplateRecipient'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mailtemplate': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'default_recipients'", 'to': u"orm['mail.MailTemplate']"}),
