...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_dashboardwidget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('column', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('index', self.gf('django.db.models.fields.IntegerField')()),
            ('widgetname', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal(u'main', ['DashboardWidget'])


    def backwards(self, orm):
        # Deleting model 'DashboardWidget'
        db.delete_table(u'main_dashboardwidget')
    ...
    models = {
        ...
        u'main.dashboardwidget': {
            'Meta': {'object_name': 'DashboardWidget'},
            'column': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'widgetname': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'users.lageruser': {
