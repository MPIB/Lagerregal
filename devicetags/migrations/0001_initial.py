...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'devicetags_devicetag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'devicetags', ['Devicetag'])

        # Adding M2M table for field devices on 'Devicetag'
        m2m_table_name = db.shorten_name(u'devicetags_devicetag_devices')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('devicetag', models.ForeignKey(orm[u'devicetags.devicetag'], null=False)),
            ('device', models.ForeignKey(orm[u'devices.device'], null=False))
        ))
        db.create_unique(m2m_table_name, ['devicetag_id', 'device_id'])


    def backwards(self, orm):
        # Deleting model 'Devicetag'
        db.delete_table(u'devicetags_devicetag')

        # Removing M2M table for field devices on 'Devicetag'
        db.delete_table(db.shorten_name(u'devicetags_devicetag_devices'))
    ...
    models = {
        ...
        u'devicetags.devicetag': {
            'Meta': {'object_name': 'Devicetag'},
            'devices': ('django.db.models.fields.related.ManyToManyField', [],
                        {'related_name': "'tags'", 'symmetrical': 'False', 'to': u"orm['devices.Device']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'devicetypes.type': {
