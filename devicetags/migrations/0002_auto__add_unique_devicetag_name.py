...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding unique constraint on 'Devicetag', fields ['name']
        db.create_unique(u'devicetags_devicetag', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Devicetag', fields ['name']
        db.delete_unique(u'devicetags_devicetag', ['name'])
