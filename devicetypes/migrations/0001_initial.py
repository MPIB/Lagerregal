...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'devicetypes_typeattributevalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('typeattribute',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devicetypes.TypeAttribute'])),
    ...
    models = {
        ...
        u'devicetypes.typeattributevalue': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'typeattribute': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devicetypes.TypeAttribute']"}),
