...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column('devices_lending', 'device_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['devices.Device']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Lending.device'
        db.alter_column('devices_lending', 'device_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Device']))
    ...
    models = {
        'auth.group': {
            ...
            'permissions': ('django.db.models.fields.related.ManyToManyField', [],
                            {'symmetrical': 'False', 'blank': 'True', 'to': "orm['auth.Permission']"})
        },
        'auth.permission': {
        ...
        'contenttypes.contenttype': {
            'Meta': {'object_name': 'ContentType', 'ordering': "('name',)",
                     'unique_together': "(('app_label', 'model'),)", 'db_table': "'django_content_type'"},
        ...
        'devices.device': {
            ...
            'bookmarkers': ('django.db.models.fields.related.ManyToManyField', [],
                            {'related_name': "'bookmarks'", 'null': 'True', 'through': "orm['devices.Bookmark']",
                             'to': "orm['users.Lageruser']", 'symmetrical': 'False', 'blank': 'True'}),
            'created_at': (
            'django.db.models.fields.DateTimeField', [], {'null': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'currentlending': ('django.db.models.fields.related.ForeignKey', [],
                               {'related_name': "'currentdevice'", 'on_delete': 'models.SET_NULL', 'null': 'True',
                                'blank': 'True', 'to': "orm['devices.Lending']"}),
            ...
            'devicetype': ('django.db.models.fields.related.ForeignKey', [],
                           {'on_delete': 'models.SET_NULL', 'null': 'True', 'blank': 'True',
                            'to': "orm['devicetypes.Type']"}),
            'group': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'devices'", 'on_delete': 'models.SET_NULL', 'null': 'True', 'blank': 'True',
            ...
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [],
                             {'on_delete': 'models.SET_NULL', 'null': 'True', 'blank': 'True',
                              'to': "orm['devices.Manufacturer']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'room': ('django.db.models.fields.related.ForeignKey', [],
                     {'on_delete': 'models.SET_NULL', 'null': 'True', 'blank': 'True', 'to': "orm['devices.Room']"}),
        ...
        'devices.lending': {
            ...
            'device': ('django.db.models.fields.related.ForeignKey', [],
                       {'null': 'True', 'blank': 'True', 'to': "orm['devices.Device']"}),
        ...
        'devices.room': {
            ...
            'building': ('django.db.models.fields.related.ForeignKey', [],
                         {'on_delete': 'models.SET_NULL', 'null': 'True', 'to': "orm['devices.Building']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'section': ('django.db.models.fields.related.ForeignKey', [],
                        {'related_name': "'rooms'", 'on_delete': 'models.SET_NULL', 'null': 'True',
                         'to': "orm['locations.Section']"})
        },
        'devices.template': {
            'Meta': {'object_name': 'Template'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
            'devicetype': ('django.db.models.fields.related.ForeignKey', [],
                           {'null': 'True', 'blank': 'True', 'to': "orm['devicetypes.Type']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [],
                             {'null': 'True', 'blank': 'True', 'to': "orm['devices.Manufacturer']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'users.lageruser': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [],
                       {'related_name': "'user_set'", 'blank': 'True', 'symmetrical': 'False',
                        'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'language': ('django.db.models.fields.CharField', [],
                         {'max_length': '10', 'default': "'de'", 'null': 'True', 'blank': 'True'}),
