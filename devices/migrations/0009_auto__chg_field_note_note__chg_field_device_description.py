...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Note.note'
        db.alter_column(u'devices_note', 'note', self.gf('django.db.models.fields.CharField')(max_length=5000))

        # Changing field 'Device.description'
        db.alter_column(u'devices_device', 'description',
                        self.gf('django.db.models.fields.CharField')(max_length=10000))

    def backwards(self, orm):
        # Changing field 'Note.note'
        db.alter_column(u'devices_note', 'note', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Device.description'
        db.alter_column(u'devices_device', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'bookmarkers': ('django.db.models.fields.related.ManyToManyField', [],
                            {'related_name': "'bookmarks'", 'symmetrical': 'False',
                             'through': u"orm['devices.Bookmark']", 'to': u"orm['users.Lageruser']"}),
            'created_at': (
