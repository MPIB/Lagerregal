...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'devices_device', 'description', self.gf('django.db.models.fields.CharField')(max_length=10000))
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'bookmarkers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'bookmarks'", 'symmetrical': 'False', 'through': u"orm['devices.Bookmark']", 'to': u"orm['users.Lageruser']"}),
