...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.department'
        db.add_column(u'devices_device', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Department'], null=True),
                      keep_default=False)

        # Adding field 'Device.is_private'
        db.add_column(u'devices_device', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.department'
        db.delete_column(u'devices_device', 'department_id')

        # Deleting field 'Device.is_private'
        db.delete_column(u'devices_device', 'is_private')
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'department': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Department']", 'null': 'True'}),
