...
class Migration(DataMigration):
    def forwards(self, orm):
        macaddresses = orm.MacAddress.objects.all()
        try:
            infotype = orm.DeviceInformationType.objects.get(keyname="macaddress")
        except:
            infotype = orm.DeviceInformationType()
            infotype.keyname = "macaddress"
            infotype.humanname = "MAC-Address"
            infotype.save()
        for macaddress in macaddresses:
            information = orm.DeviceInformation()
            information.infotype = infotype
            information.information = macaddress.macaddress
            information.device = macaddress.device
            information.save()
            macaddress.delete()

    def backwards(self, orm):
        macaddresses = orm.DeviceInformation.objects.filter(infotype__keyname="macaddresses")
        for macaddress in macaddresses:
            newmacaddress = orm.MacAddress()
            newmacaddress.macaddress = macaddress.information
            newmacaddress.device = macaddress.device
            newmacaddress.save()
            macaddress.delete()
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'bookmarkers': ('django.db.models.fields.related.ManyToManyField', [],
                            {'related_name': "'bookmarks'", 'to': u"orm['users.Lageruser']",
                             'through': u"orm['devices.Bookmark']", 'blank': 'True', 'symmetrical': 'False',
                             'null': 'True'}),
            'created_at': (
        ...
        u'devices.deviceinformation': {
            ...
            'device': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'information'", 'to': u"orm['devices.Device']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'information': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'infotype': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['devices.DeviceInformationType']"})
        },
        ...
        u'devices.macaddress': {
            ...
            'device': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'macaddresses'", 'to': u"orm['devices.Device']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'devices.room': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [],
                        {'related_name': "'rooms'", 'null': 'True', 'on_delete': 'models.SET_NULL',
                         'to': u"orm['locations.Section']"})
        },
        u'devices.template': {
