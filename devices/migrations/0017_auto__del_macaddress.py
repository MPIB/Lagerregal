...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('devices_macaddress', (
            ...
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(related_name='macaddresses', to=orm['devices.Device'])),
    ...
    models = {
        ...
        'devices.device': {
            ...
            'bookmarkers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['users.Lageruser']", 'null': 'True', 'related_name': "'bookmarks'", 'through': "orm['devices.Bookmark']", 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Lageruser']"}),
            'currentlending': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'currentdevice'", 'to': "orm['devices.Lending']", 'null': 'True', 'blank': 'True', 'on_delete': 'models.SET_NULL'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '10000', 'blank': 'True'}),
            'devicetype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devicetypes.Type']", 'null': 'True', 'blank': 'True', 'on_delete': 'models.SET_NULL'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'devices'", 'to': "orm['devicegroups.Devicegroup']", 'null': 'True', 'blank': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devices.Manufacturer']", 'null': 'True', 'blank': 'True', 'on_delete': 'models.SET_NULL'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devices.Room']", 'null': 'True', 'blank': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        'devices.room': {
            ...
            'building': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devices.Building']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rooms'", 'to': "orm['locations.Section']", 'null': 'True', 'on_delete': 'models.SET_NULL'})
        },
        'devices.template': {
            'Meta': {'object_name': 'Template'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
            'devicetype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devicetypes.Type']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devices.Manufacturer']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'users.lageruser': {
            ...
            'language': ('django.db.models.fields.CharField', [], {'default': "'de'", 'null': 'True', 'max_length': '10', 'blank': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'pagelength': ('django.db.models.fields.IntegerField', [], {'default': '30'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'timezone': ('django.db.models.fields.CharField', [], {'default': 'None', 'null': 'True', 'max_length': '50', 'blank': 'True'}),
