...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding unique constraint on 'MacAddress', fields ['macaddress']
        db.create_unique(u'devices_macaddress', ['macaddress'])


    def backwards(self, orm):
        # Removing unique constraint on 'MacAddress', fields ['macaddress']
        db.delete_unique(u'devices_macaddress', ['macaddress'])
