...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'devices_macaddress', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('macaddress', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(related_name='macaddresses',
                                                                             to=orm['devices.Device'])),
        ))
        db.send_create_signal(u'devices', ['MacAddress'])


    def backwards(self, orm):
        # Deleting model 'MacAddress'
        db.delete_table(u'devices_macaddress')
