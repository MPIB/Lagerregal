...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'devices_room', 'building_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Building'], null=True,
                                                                              on_delete=models.SET_NULL))
        # Adding field 'Device.inventoried'
        db.add_column(u'devices_device', 'inventoried',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Device.group'
        db.alter_column(u'devices_device', 'group_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['devicegroups.Devicegroup']))

        # Changing field 'Device.currentlending'
        db.alter_column(u'devices_device', 'currentlending_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['devices.Lending']))

        # Changing field 'Device.devicetype'
        db.alter_column(u'devices_device', 'devicetype_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devicetypes.Type'], null=True,
                                                                              on_delete=models.SET_NULL))

        # Changing field 'Device.manufacturer'
        db.alter_column(u'devices_device', 'manufacturer_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Manufacturer'], null=True,
                                                                              on_delete=models.SET_NULL))

        # Changing field 'Device.room'
        db.alter_column(u'devices_device', 'room_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Room'], null=True,
                                                                              on_delete=models.SET_NULL))
    ...
    def backwards(self, orm):
        ...
        db.alter_column(u'devices_room', 'building_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Building'], null=True))
        # Deleting field 'Device.inventoried'
        db.delete_column(u'devices_device', 'inventoried')


        # Changing field 'Device.group'
        db.alter_column(u'devices_device', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True,
                                                                                                             to=orm[
                                                                                                                 'devicegroups.Devicegroup']))

        # Changing field 'Device.currentlending'
        db.alter_column(u'devices_device', 'currentlending_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['devices.Lending']))
        ...
        # Changing field 'Device.manufacturer'
        db.alter_column(u'devices_device', 'manufacturer_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Manufacturer'],
                                                                              null=True))
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'currentlending': ('django.db.models.fields.related.ForeignKey', [],
                               {'blank': 'True', 'related_name': "'currentdevice'", 'null': 'True',
                                'on_delete': 'models.SET_NULL', 'to': u"orm['devices.Lending']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
            'devicetype': ('django.db.models.fields.related.ForeignKey', [],
                           {'to': u"orm['devicetypes.Type']", 'null': 'True', 'on_delete': 'models.SET_NULL',
                            'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [],
                      {'blank': 'True', 'related_name': "'devices'", 'null': 'True', 'on_delete': 'models.SET_NULL',
            ...
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [],
                             {'to': u"orm['devices.Manufacturer']", 'null': 'True', 'on_delete': 'models.SET_NULL',
                              'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'room': ('django.db.models.fields.related.ForeignKey', [],
                     {'to': u"orm['devices.Room']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'devices.room': {
            ...
            'building': ('django.db.models.fields.related.ForeignKey', [],
                         {'to': u"orm['devices.Building']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'devices.template': {
